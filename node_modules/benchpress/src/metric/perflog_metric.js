  ...
  _readUntilEndMark: function(markName) {
    ...
    return this._driverExtension.readPerfLog().then((function(events) {
      ...
      $__7._setTimeout((function() {
        return completer.complete($__7._readUntilEndMark(markName, loopCount + 1));
      }), 100);
...
var _BINDINGS = [bind(PerflogMetric).toFactory((function(driverExtension, setTimeout) {
...
//# sourceMappingURL=/Users/tbosch/projects/angular2/modules/benchpress/src/metric/perflog_metric.map
