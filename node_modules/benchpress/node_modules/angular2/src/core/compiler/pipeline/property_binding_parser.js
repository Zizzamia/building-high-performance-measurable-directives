    ...
    MapWrapper.forEach(attrs, (function(attrValue, attrName) {
      ...
      if (isPresent(bindParts)) {
        if (isPresent(bindParts[1])) {
          current.addPropertyBinding(bindParts[4], $__7._parseBinding(attrValue));
          ...
          current.addEventBinding(bindParts[4], $__7._parseAction(attrValue));
        } else if (isPresent(bindParts[5])) {
          current.addPropertyBinding(bindParts[5], $__7._parseBinding(attrValue));
        } else if (isPresent(bindParts[6])) {
          current.addEventBinding(bindParts[6], $__7._parseBinding(attrValue));
        }
      } else {
        var ast = $__7._parseInterpolation(attrValue);
        if (isPresent(ast)) {
